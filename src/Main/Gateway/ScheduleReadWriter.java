...
public class ScheduleReadWriter implements ReadWriter{
     ...
     * @param schedules    stores the list of users to be serialized
     */
    @Override
    public void saveToFile(String filePath, Object schedules) throws IOException {
    ...
    public HashMap<String, Integer> readFromFile(String filePath) throws IOException, ClassNotFoundException {
        ...
        HashMap<String, Integer> schedules_list = (HashMap<String, Integer>) input.readObject();
        // serialize the Map
        input.close();
